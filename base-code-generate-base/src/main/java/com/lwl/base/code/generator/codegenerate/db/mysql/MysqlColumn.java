...
import com.lwl.base.code.generator.codegenerate.db.JavaConverter;
 ...
 */
@Data
public class MysqlColumn implements JavaConverter<ColumnBean> {
    ...
    public ColumnBean convert() {
        ...
        return new ColumnBean(this.field, mysql57Mapping.getJavaType(), mysql57Mapping.getImp(), this.comment);
    }
}
